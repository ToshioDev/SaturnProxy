...
public class PacketUtils
{
    ...
    public static void init()
    {
        ...
        kickMessagesGame.put( KickType.BIG_PACKET, new CachedPacket( createKickPacket( "§cNo se pudo verificar si eres un bot. Por favor, informe a la administración. (Se envió un paquete grande)" ), kickGame ) );
